...
<section class="training_container container">
    <div class="training_header_container">
        <article class="training_header" >
            <div class="training_link">
                <a href="#">Formations </a> > <a href="#"> Rediger son mémoire</a></div>
            <div class="training_details">
                <h2 class="title">Cours sur l'édition d'un rapport de mémoire et de stage</h2>
                <p class="p_details">
                    <span>Langue : Français </span><br>
                    <span>Crée par: Sorelle Kana </span><br>
                    <span>Dernière mise à jour : 20 Août 2020</span><br>
                    <br>
                ...
                <div class="cards card_price">
                    <p> Debutez votre formation maintenant à  <span style="font-weight: bold"> 5000 FCFA  </span></p><br>
    ...
    <article class="program_training">
        ...
        <ul >
            <li class="list">Titre 1</li>
            <li class="list">Titre 2</li>
            <li class="list">Titre 3</li>
            <li class="list">Titre 4</li>
            <li class="list">Titre 5</li>
        </ul>
    </article>
